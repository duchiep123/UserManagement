 ...
 * @author mrhie
 */
public class RemoveUserFromPromotionList extends HttpServlet {
        ...
        try {
            ...
            for (int i = 0; i < listPromotion.size(); i++) {
                if (listPromotion.get(i).getUserID().equals(userID)) {
                    ...
                    request.setAttribute("Mes", "Remove user success.");
                    break;
                }
            }
            ...
            log("Error at RemoveUserFromPromotionList: " + e.getMessage());
        } finally {
